package com.abubakar.friendstracker.SupportCode;
...
public class TestLocationService {
    ...
    public static void test(Context context) {
        ...
        List<DummyLocationService.FriendLocation> matched = dummyLocationService.getFriendLocationsForTime(new Date(), 2, 0);
